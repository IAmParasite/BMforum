from movie_comments.models import MovieComment
...
def report(request, post_pk):
    post = get_object_or_404(MovieComment, pk=post_pk)
    ...
    if form.is_valid():
        ...
        return render(request, 'movie_reports/preview.html', context=context)
    context = {
        'post': post,
        'form': form,
    }
